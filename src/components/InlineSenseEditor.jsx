...
export default function InlineSenseEditor({ 
    ...
    const editPillClass = "inline-flex items-center gap-1 bg-surface-container-high border border-primary/30 px-2 py-0.5 text-[9px] font-bold font-label uppercase tracking-widest text-primary shadow-sm";
